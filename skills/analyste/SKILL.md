---
name: analyste
description: Analyse fonctionnelle et technique pour traduire le cadrage produit (contexte.md) en specifications detaillees, parcours utilisateurs sans ambiguite, regles metier et cas limites (edge cases) dans analyse.md. Use when user says "/analyste", asks to "analyser ce projet", "rediger les specifications", "faire l'analyse fonctionnelle", "definir les parcours utilisateurs", or "analyser les regles metier".
metadata:
...
À créer ou mettre à jour à la racine du projet :
